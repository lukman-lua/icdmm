...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('dashboardpeserta') }}">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Paper</h1>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('submit_paper') }}" enctype="multipart/form-data" id="myForm">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="paperTitle" id="paperTitle" placeholder="Enter the paper title" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" name="coAuthorsEmail" id="coAuthorsEmail" placeholder="Enter co-authors' emails" required>
                                </div>
                                <div class="form-group">
                                    <label for="institution">University/Institute or Company Name:</label>
                                    <input type="text" class="form-control" name="institution" id="institution" placeholder="Enter your institution/company name" required>
                                </div>
                                <div class="form-group">
                                    <label for="officeAddress">Office Address:</label>
                                    <input type="text" class="form-control" name="officeAddress" id="officeAddress" placeholder="Enter your office address" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="fileUpload">Upload Paper File:</label>
                                    <input type="file" class="form-control-file" name="fileUpload" id="fileUpload" required>
                                </div>

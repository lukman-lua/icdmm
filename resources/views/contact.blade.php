    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4">
          <div class="col-lg-6">
            <div class="info-item  d-flex flex-column justify-content-center align-items-center">
              <i class="bi bi-map"></i>
              <h3>Our Address</h3>
              <p>Limau Manis, Kec. Pauh, Kota Padang, Sumatera Barat 25175</p>
            </div>
          </div><!-- End Info Item -->
          ...
          <div class="col-lg-3 col-md-6">
            <div class="info-item  d-flex flex-column justify-content-center align-items-center">
              ...
              <h3>Call Us</h3>
              <ul>
                <li>+62 852 6352 1435 (Rina Yuliet)</li>
                <li>+62 898 9483 468 (Husna)</li>
                <li>+62 822 6872 0478 (Sri)</li>
              </ul>
            </div>
          </div><!-- End Info Item -->
        ...
        <div class="row gy-4 mt-1">
          ...
          <div class="col-lg-6 ">
            <iframe
              src="https://goo.gl/maps/ZFKHSPDQ75APVkye9"
